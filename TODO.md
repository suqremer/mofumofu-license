...
- [x] コレクション: ペット毎グループ表示のUI改善 → 2列ペットカード+タップ展開で免許証一覧表示（2026-03-18）
- [x] エディタ: ガイドシステムをモード別に変更 → コスチューム:顔ガイド線+GIF / 背景削除:GIF4種 / デコ:GIF1種 / 色調整:なし（2026-03-18）※GIF素材はエミュレータ録画→変換が必要
- [x] エディタ: ガイドの顔シルエット線はコスチュームタブのみ表示 → _mode==EditorMode.outfitで条件分岐（2026-03-18）

### GIF素材作成（しゅーと担当）
- [ ] assets/tutorial/guide_outfit.gif — コスチュームタブ: 顔合わせ+コスチューム選択
- [ ] assets/tutorial/guide_brush_offset.gif — 背景削除: オフセット操作
- [ ] assets/tutorial/guide_brush_eraser.gif — 背景削除: 消しゴム操作
- [ ] assets/tutorial/guide_brush_restore.gif — 背景削除: 復元操作
- [ ] assets/tutorial/guide_brush_lasso.gif — 背景削除: 投げ縄操作
- [ ] assets/tutorial/guide_deco.gif — デコタブ: デコレーション操作
